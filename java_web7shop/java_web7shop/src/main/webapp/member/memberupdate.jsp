...
<table>
		<tr>
			<td align="center">
				<form name="upForm" method="post" action="memberupdateproc.jsp">
					<table border="1">
						<tr align="center" style="background-color: pink">
							<td colspan="2"><b style="color: #000"><%=dto.getName() %> 회원 수정</b></td>
						</tr>
						<tr>
							<td width="17%">아이디</td>
							<td width="57%"><%=dto.getId() %></td>
						</tr>
						<tr>
							<td>패스워드</td>
						...
						<tr>
						 	<td>우편번호</td>
							<td><input type="text" name="zipcode" size="7" value="<%=dto.getZipcode() %>"></td>
						</tr>
						<tr>
							<td>주소</td>
						...
						<tr>
							...
							<input type="reset" value="회원탈퇴" id="btnDelete">
						</tr>
					</table>
				</form>
			</td>
